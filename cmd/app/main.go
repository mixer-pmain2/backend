...
func main() {
	...
	apiRouter.HandleFunc("/patient/{id:[0-9]*}/history/visit/", apperror.Middleware(apiHandlers.Patient.HistoryVisits)).Methods(http.MethodGet, http.MethodOptions)
	apiRouter.HandleFunc("/patient/{id:[0-9]*}/history/hospital/", apperror.Middleware(apiHandlers.Patient.HistoryHospital)).Methods(http.MethodGet, http.MethodOptions)
